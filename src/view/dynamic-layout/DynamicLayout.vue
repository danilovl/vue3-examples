            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <ul class="nav-links mb-4">
                        <li class="nav-item">
                            <router-link :to="{name: 'dynamic_layout_simple'}" active-class="active">
                                simple template
                            </router-link>
                        </li>
                        <li class="nav-item">
                            <router-link :to="{name: 'dynamic_layout_blog'}" active-class="active">
                                blog template
                            </router-link>
                        </li>
                    </ul>
                    ...
                    <component v-if="state.layout" :is="state.layout">
                        <template v-slot:content>
                            ...
                            <p>Cum sociis natoque penatibus et magnis <a href="#">dis parturient montes</a>, nascetur
                                ridiculus mus.
                                Aenean eu
                                leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere
                                consectetur est at
                                lobortis.
